...
from agrianalyze.knowledge.kb_loader import DiseaseProfile
from agrianalyze.vision.feature_extractor import extract_features, ImageFeatures
from agrianalyze.vision.rule_engine import evaluate as rule_evaluate, result_to_dict as rule_result_to_dict, RuleEngineResult
from agrianalyze.core.spectral_features import extract_spectral_indices, spectral_to_dict, SpectralResult
