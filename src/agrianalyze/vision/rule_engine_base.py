...
def _register_defaults() -> None:
    try:
        from agrianalyze.vision.rule_engine import evaluate as _handcrafted
    ...
    try:
        from agrianalyze.vision.rules_learned import evaluate_learned
    ...
    try:
        from agrianalyze.vision.rules_llm import evaluate_llm
