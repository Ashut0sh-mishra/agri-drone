# agrianalyze — Python Package (Backend Core)

This is the main Python package for the AgriAnalyze backend.
...
```bash
# From the project root (agri-analyze/)
uvicorn agrianalyze.api.app:app --host 127.0.0.1 --port 9000 --reload
```
