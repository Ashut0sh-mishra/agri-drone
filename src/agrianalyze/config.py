...
class AppSettings(BaseModel):
    ...
    # Application
    app_name: str = "agrianalyze"
    app_version: str = "0.1.0"
    debug: bool = False

    # Logging
    log_level: str = "INFO"
    log_file: Path = Path("outputs/logs/agrianalyze.log")
    ...
    def from_env(cls, env_file: str = ".env") -> "AppSettings":
        ...
        return cls(
            app_name=_env("APP_NAME", "agrianalyze"),
            debug=_env_bool("DEBUG", False),
            log_level=_env("LOG_LEVEL", "INFO"),
            log_file=Path(_env("LOG_FILE", "outputs/logs/agrianalyze.log")),
