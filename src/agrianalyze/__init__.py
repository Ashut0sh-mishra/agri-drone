"""
AgriAnalyze: Low-cost research prototype for site-specific crop protection.
...
__version__ = "0.1.0"
__author__ = "AgriAnalyze Research Team"

# Lazy imports — defer heavy modules so that import agrianalyze never crashes
