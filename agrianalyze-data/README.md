...
- computer-vision
- plant-pathology
pretty_name: AgriAnalyze Crop Disease Dataset
size_categories:
- 10K<n<100K
---

# AgriAnalyze — Crop Disease Detection Dataset

Full dataset collection used for training the AgriAnalyze crop-disease
detection system (21-class YOLOv8n-cls classifier, 15 wheat + 6 rice
diseases). **75,010 images, 24 folders, 23.6 GB.**

Code repo: <https://github.com/Ashut0sh-mishra/agri-analyze>
...
Use these URLs directly in the AgriAnalyze frontend dashboard for live data display.
...
See the AgriAnalyze repo: <https://github.com/Ashut0sh-mishra/agri-analyze>
