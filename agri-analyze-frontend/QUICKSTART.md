# AgriAnalyze Frontend - Quick Start Guide
...
In a separate terminal, from the `agri-analyze` directory:
...
From the `agri-analyze-frontend` directory:
...
You should see the AgriAnalyze dashboard with:
...
- Start it with: `uvicorn agrianalyze.api.app:app --reload`
