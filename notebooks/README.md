...
| `AgriDrone_Mega_Dataset_CLS_Training.ipynb` | **Mega dataset classification training** — downloads ~30 K images, converts to cls format, trains YOLOv8n-cls (22 classes), saves `best.pt` to Drive | `ROBOFLOW_API_KEY`, `KAGGLE_API_TOKEN` |
...
```
1. Open AgriDrone_Mega_Dataset_CLS_Training.ipynb in Colab
