...
# ---------------------------------------------------------------------------
# Ensure agrianalyze is importable when running from the project root
# ---------------------------------------------------------------------------
...
from agrianalyze.services.llm_service import LLMService
...
<div class="header">
    ...
    <div class="gen-by">Generated by AgriAnalyze AI System &nbsp;|&nbsp; YOLOv8 + LLaVA Vision &nbsp;|&nbsp; Open Source</div>
</div>
...
<div class="footer">
    ...
    <p style="margin-top:10px;color:#d1d5db;">
        &copy; {datetime.now().year} AgriAnalyze AI &mdash; Open Source Precision Agriculture
    </p>
</div>
...
def _default_research_notes(
    ...
    return (
        ...
        f"reproduced using the AgriAnalyze pipeline. The methodology is suitable for "
