# agri-drone-frontend — React Web App

This is the React + Vite frontend for the AgriDrone project.
It communicates with the Python FastAPI backend (`agri-drone/`) over HTTP.
...
- **Backend**: Render (config in `agri-drone/render.yaml`)
