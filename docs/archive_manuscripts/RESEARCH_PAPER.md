# AgriAnalyze: A Multi-Model Ensemble Framework for Explainable Crop Disease Diagnosis with Real-Time Drone Imagery
...
AgriAnalyze follows a layered architecture with clear separation between perception, reasoning, decision, and presentation layers:
