...
MODELS = [
    r"D:\Projects\agridrone_training_results\best.pt",
    r"D:\Projects\agri-drone\runs\detect\outputs\training\best.pt",
    r"D:\Projects\agri-drone\outputs\training\rice_v2\best.pt",
    r"D:\Projects\agri-drone\outputs\training\india_agri_cls\best.pt",
]

VAL_DIR = Path(r"D:\Projects\wheat-split\val")
DEST = Path(r"D:\Projects\agri-drone\models\best_wheat.pt")
...
# Save results
out = Path(r"D:\Projects\agri-drone\evaluate\results\model_comparison.json")
